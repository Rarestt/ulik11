<x-layout>
            ...
            <form>
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        <input class="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Find for article" type="search" id="search" name="search" autocomplete="off">
                    </div>
                    <div>
    ...
    <div class="my-4 py-2 px-4 mx-auto max-w-screen-xl lg:py-4 lg:px-0">
        ...
        @forelse ($posts as $post)
            <article class="p-6 bg-white rounded-xl border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 hover:shadow-2xl duration-500">
